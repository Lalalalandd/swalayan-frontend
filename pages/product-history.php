        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#">ProductHistory</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                  <div class="form-row" >
                    <div class="form-group col-md-3">
                      <h3 class="card-title" style="margin-right: 10px;">All Product History</h3>
                    </div>
                    <div class="form-group col-md-3">
                    <label for="inputId">Id</label>
                      ...
                      <label for="inputVersion">Version</label>
                        <input type="number" class="form-control" id="inputVersion" placeholder="Select Version">
                        </select>
                      </div>
                      <div class="form-group col-md-3">
